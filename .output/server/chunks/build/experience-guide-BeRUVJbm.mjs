...
const _imports_0 = "" + buildAssetsURL("experience-guide-1.ClCefJUw.webm");
const _imports_1 = "" + buildAssetsURL("experience-guide-1.C8RwdzxF.mp4");
const _imports_2 = "" + buildAssetsURL("experience-guide-2-2x.CCigUcgT.jpg");
const _imports_3 = "" + buildAssetsURL("experience-guide-3.BX7R5v2N.webm");
const _imports_4 = "" + buildAssetsURL("experience-guide-3.CCAF5lpv.mp4");
const _imports_5 = "" + buildAssetsURL("experience-guide-4-2x.fjG2bAtS.jpg");
const _imports_6 = "" + buildAssetsURL("experience-guide-5.--tMpd5C.gif");
const _imports_7 = "" + buildAssetsURL("experience-guide-6-2x.BXeGIT25.jpg");
const _imports_8 = "" + buildAssetsURL("experience-guide-7-2x.CJFXkBFE.jpg");
const copy = {
  intro: {
    title: "IBM Security Experience Guide",
    subtitle: "Building a new, scalable home for our team\u2019s local design system.",
    description: 'My first project after rejoining the IBM Security design team was to design a new system for our Experience Guide, our local design system built off of the <a href="https://www.carbondesignsystem.com/" target="_blank">Carbon Design System</a> and the <a href="https://www.ibm.com/design/language/" target="_blank">IBM Design Language</a> (IDL). With more teams and types of content to include and a growing need to improve consistency and alignment across teams, our old system was having trouble scaling. What started as a simple site update evolved into a new system to align our design teams across product, brand, marketing, and research, as well as a consistent experience for designers needing to utilize local design systems alongside Carbon and the IDL.',
    role: "Product Designer, November 2019",
    teammates: [
      {
        name: "Randy Tolentino",
        link: "https://randytolentino.com/",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="project-feature-img video column"><video width="100%" muted autoplay loop playsinline disableRemotePlayback currentTime="0" alt="Video showing scrolling through the experience guide homepage." aria-labelledby="experience-guide-1-caption"><source${ssrRenderAttr("src", _imports_0)} type="video/webm"><source${ssrRenderAttr("src", _imports_1)} type="video/mp4"></video></div><div class="caption" id="experience-guide-1-caption"> Our Experience Guide brought together design teams and resources across brand, product, research, and strategy. </div><div class="content container"><div class="content-sub column">`);
      _push(ssrRenderComponent(QuoteSection, {
        copy: unref(copy).systemsThinkingQuote
      }, null, _parent));
      _push(`</div><div class="spacer column"></div><div class="content-main column">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        copy: unref(copy).problem
      }, null, _parent));
      _push(`</div></div><div class="project-feature-img container"><img${ssrRenderAttr("src", _imports_2)} alt="Image showing site map and screenshot of Github repo" aria-labelledby="experience-guide-2-caption"><div class="caption" id="experience-guide-2-captio"> Working up front on site maps and collaborating in Github helped keep me and Randy aligned as a team and with leadership. </div></div><div class="content container"><div class="content-main column">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        copy: unref(copy).process
      }, null, _parent));
      _push(`</div></div><div class="project-feature-img video column"><video width="100%" muted autoplay loop playsinline disableRemotePlayback currentTime="0" alt="Prototype of a page for a user persona." aria-labelledby="experience-guide-3-caption"><source${ssrRenderAttr("src", _imports_3)} type="video/webm"><source${ssrRenderAttr("src", _imports_4)} type="video/mp4"></video></div><div class="caption" id="experience-guide-3-caption"> I used animated prototypes to quickly iterate and fine-tune microinteractions like scroll behavior, hover states, or breadcrumbs. </div><div class="content container"><div class="content-sub placeholder column"></div><div class="spacer column"></div><div class="content-main column">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        copy: unref(copy).buildingHome
      }, null, _parent));
      _push(`</div></div><div class="project-feature-img column"><img${ssrRenderAttr("src", _imports_5)} alt="Screenshot of photography resources within the marketing assets page of our experience guide." aria-labelledby="experience-guide-4-caption"><div class="caption" id="experience-guide-4-caption"> As the site and list of involved teams have grown, the Marketing assets page remains the most popular page, giving designers a single place to find the most up to date guidelines and assets. </div></div><div class="content container"><div class="content-main column">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        copy: unref(copy).newSkills
      }, null, _parent));
      _push(`</div></div><div class="project-feature-img video centered column"><img${ssrRenderAttr("src", _imports_6)} alt="Video showing a cursor hovering over a UI card within a catalog of research artifacts."></div><div class="img-container container" aria-labelledby="experience-guide-6-caption"><div class="project-feature-img half column"><img${ssrRenderAttr("src", _imports_7)} alt="Screenshot of the research section of the experience guide homepage"></div><div class="project-feature-img half column"><img${ssrRenderAttr("src", _imports_8)} alt="Image showing the mobile view of a research catalog."></div><div class="caption" id="experience-guide-6-caption"> Adding a catalog of research findings was an key part of our work. We considered how the research would be consumed to allow designers to utilize the research throughout their design process. </div></div><div class="content container"><div class="content-sub column">`);
      _push(ssrRenderComponent(QuoteSection, {
        copy: unref(copy).philQuote
      }, null, _parent));
      _push(`</div><div class="spacer column"></div><div class="content-main column">`);
      _push(ssrRenderComponent(_sfc_main$1, {
      ...
      _push(`</div></div>`);
      _push(ssrRenderComponent(_sfc_main$1$1, { active: "experienceGuide" }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/experience-guide.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=experience-guide-BeRUVJbm.mjs.map
