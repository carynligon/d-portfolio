...
const _imports_0 = "" + buildAssetsURL("cloud-pak-1-2x.FZUl8P1q.jpg");
const _imports_1 = "" + buildAssetsURL("cloud-pak-2-2x.BPybt1kX.jpg");
const _imports_2 = "" + buildAssetsURL("cloud-pak-3-2x.Lm-NAkXp.jpg");
const _imports_3 = "" + buildAssetsURL("cloud-pak-4.CvNudy-g.webm");
const _imports_4 = "" + buildAssetsURL("cloud-pak-4.Bs_so-AN.mp4");
const _imports_5 = "" + buildAssetsURL("cloud-pak-5-2x.Bux1xybO.jpg");
const _imports_6 = "" + buildAssetsURL("cloud-pak-6-2x.CJNWfyaD.jpg");
const _imports_7 = "" + buildAssetsURL("cloud-pak-7-2x.USQ1jrSh.jpg");
const _imports_8 = "" + buildAssetsURL("cloud-pak-8-2x.D4G9TNQU.jpg");
const copy = {
  intro: {
    title: "IBM Cloud Pak for Security",
    subtitle: "Designing a common platform to solve security workers\u2019 pain points.",
  ...
  problem: {
    title: "The problem",
    subtitle: "With a growing amount of tools & data spread across large companies, how do they stay secure? ",
    paragraphs: [
  ...
  scalable: {
    subtitle: "A scalable system for users to create and customize security dashboards.",
    paragraphs: [
  ...
  peterQuote: {
    quote: "\u201CDerrick\u2019s ability to leverage existing patterns, explore different solutions, and include delightful moments within designs while understanding the entire user flow results in thoughtful experiences.\u201D",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="project-feature-img container"><img${ssrRenderAttr("src", _imports_0)} alt="Cloud Pak for Security homepage with application links and dashboard" aria-labelledby="cloud-pak-1-caption"><div class="caption" id="cloud-pak-1-caption"> Our homepage is a jumping off point for users through dashboards, onboarding experiences, and quick access to capabilities. </div></div><div class="content container"><div class="content-sub column">`);
      _push(ssrRenderComponent(QuoteSection, {
        copy: unref(copy).processQuote
      }, null, _parent));
      _push(`</div><div class="spacer column"></div><div class="content-main column">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        copy: unref(copy).problem
      }, null, _parent));
      _push(`<div class="button-container"><a href="https://www.ibm.com/products/cloud-pak-for-security" target="_blank" class="button">Visit Cloud Pak Site</a></div></div></div><div class="project-feature-img container"><img${ssrRenderAttr("src", _imports_1)} alt="User flow diagram showing the old dashboard experience" aria-labelledby="cloud-pak-2-caption"><div class="caption" id="cloud-pak-2-caption"> Audit of the existing, legacy dashboarding experience to understand gaps, pain points, and user needs. </div></div><div class="content container"><div class="content-main column">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        copy: unref(copy).process
      }, null, _parent));
      _push(`</div></div><div class="project-feature-img container"><img${ssrRenderAttr("src", _imports_2)} alt="Divided image showing process screenshots of a user flow diagram and a mid-fidelity prototype" aria-labelledby="cloud-pak-3-caption"><div class="caption" id="cloud-pak-3-caption"> User flows and mid-fidelity designs help us quickly align around the overall user experience before investing too much time. </div></div><div class="content container"><div class="content-sub placeholder column"></div><div class="spacer column"></div><div class="content-main column">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        copy: unref(copy).scalable
      }, null, _parent));
      _push(`</div></div><div class="project-feature-img video column"><video width="100%" muted autoplay loop playsinline disableRemotePlayback currentTime="0" alt="Animated prototype of the scroll interaction for a dashboard widget library"><source${ssrRenderAttr("src", _imports_3)} type="video/webm"><source${ssrRenderAttr("src", _imports_4)} type="video/mp4"></video></div><div class="caption"> Animated prototypes in Flinto helped to quickly explore microinteractions like scrolling show here. </div><div class="content container"><div class="content-main column">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        copy: unref(copy).planning
      }, null, _parent));
      _push(`</div></div><div class="project-feature-img container"><img${ssrRenderAttr("src", _imports_5)} alt="Invision prototype for selecting widgets to add to a dashboard" aria-labelledby="cloud-pak-5-caption"><div class="caption" id="cloud-pak-5-caption"> Invision prototype used for user testing sessions. Helped us understand how users edit and create dashboards and widgets. </div></div><div class="content container"><div class="content-sub no-title column">`);
      _push(ssrRenderComponent(QuoteSection, {
        copy: unref(copy).peterQuote
      }, null, _parent));
      _push(`</div><div class="spacer column"></div><div class="content-main column">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        copy: unref(copy).findings
      }, null, _parent));
      _push(`</div></div><div class="project-feature-img container"><img${ssrRenderAttr("src", _imports_6)} alt="Screenshot showing a dropdown for a user to change dashboards"></div><div class="img-container container column"><div class="project-feature-img column"><img class="project-feature-img"${ssrRenderAttr("src", _imports_7)} alt="Zoomed in screenshot of dashboard action bar with available updates"></div><div class="project-feature-img column"><img class="project-feature-img"${ssrRenderAttr("src", _imports_8)} alt="Documentation showing feedback and proposed updates to widget card components" aria-labelledby="cloud-pak-8-caption"></div><div class="caption" id="cloud-pak-8-caption"> Updating shared dashboards, widgets details, and how users create new dashboards were all influenced by user testing. </div></div><div class="content container"><div class="content-main column">`);
      _push(ssrRenderComponent(_sfc_main$1, {
        copy: unref(copy).next
      }, null, _parent));
      _push(`</div></div>`);
      _push(ssrRenderComponent(_sfc_main$1$1, { active: "cloudPak" }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/cloud-pak.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=cloud-pak-WkEvmg_p.mjs.map
