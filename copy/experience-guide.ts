export default {
  intro: {
    ...
    subtitle:
      'Building a new, scalable home for our team’s local design system.',
    description:
  ...
  problem: {
    title: 'The problem',
    subtitle:
      'As design systems grow, how do we ensure the experiences for using and consuming those systems can scale?',
    paragraphs: [
  ...
  systemsThinkingQuote: {
    quote:
      '“Your design system is only as strong as your relationships with the teams who use it.”',
  ...
  buildingHome: {
    subtitle:
      'Applying systems thinking to building a home for our design system.',
    paragraphs: [
  ...
  newSkills: {
    subtitle:
      'Using new skills to help empower teammates to focus on their strengths.',
    paragraphs: [
  ...
  philQuote: {
    quote:
      '“Security was the team that really pioneered our experience guides. I think we should double down on this concept.”',
    author: 'Phil Gilbert, General Manager for IBM Design'
  },
  outcomes: {
    title: 'Outcomes',
    subtitle:
      'Better collaboration and a more consistent experience across IBM',
    paragraphs: [
