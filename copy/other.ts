export default {
  intro: {
    title: 'Other work',
    subtitle:
      'A collection of smaller, meaningful projects from throughout my career.',
    description:
      'My career has included a variety of different work up to this point. For some projects, whether it’s the amount of available work examples or documentation or the size of the project, they may nor warrant their own page but the impact of the work or how well it depicts my values, interests, or abilities make them worth including.',
    timeline: 'June 2015–June 2020'
  },
  projects: [
    {
      title:
        'The first set of illustration guidelines included in the IBM Design Language.',
      date: 'April 2020',
      company: 'IBM Design',
    ...
    {
      title:
        'Helping legal teams manage legal matters and respond to litigation.',
      date: '2015-2016',
      company: 'IBM Design',
      tags: [
        'Product design',
      ...
      paragraphs: [
        ...
        },
        {
          list: [
            ...
            'Embedding with our global engineering team for a 2-week “war room” in Böblingen, Germany.'
          ]
        }
      ],
      contact: {
