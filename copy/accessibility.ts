export default {
  intro: {
    ...
    subtitle:
      'Helping teams across IBM deliver inclusive and accessible products.',
    description:
      'Accessibility is an important part of the training new designers receive as part of IBM’s new hire design camp program. Designers are given materials they can utilize and take part in accessibility hackathon to build empathy, skills, and an understanding of the role accessibility plays in the design process. Even with the emphasis on accessibility initially, those experiences are often forgotten or not applied. The goal of this project was to empower not only designers, but developers and product managers across IBM to deliver inclusive, accessible products.',
    role: 'Designer, 2016',
    teammates: [
      {
        name: 'Hayley Hughes',
  ...
  problem: {
    title: 'The problem',
    subtitle:
      'How do you help team view accessibility as part of the whole team’s job instead of someone else’s job?',
    paragraphs: [
  ...
  stats: {
    quote:
      'In its first year, the IBM Accessibility Handbook had more than 50k views and over 10k printed copies distributed.',
    noQuotes: true,
